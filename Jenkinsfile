...
try
{
    ...
    p << new Stage('Smoke Test', this)
        .addStep(new RegressionX86StepVJ(this,'../../../jenkins-regression-tests/regression-suites/linux-x86-smoke', 'wherever', env.WORKSPACE, "${BUILD_URL}", SRS_REVISION_ID, SCC_REVISION_ID, SBUS_REVISION_ID, 'x86-smoketest'))
